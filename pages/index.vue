...
<template>
  <div class="max-w-xl mx-auto text-black" style="background-image: linear-gradient(109.6deg, rgba(61,245,167,1) 11.2%, rgba(9,111,224,1) 91.1%)">
    <h1 class="my-8 text-5xl font-bold text-center text-black">Atlaspad Chatbot</h1>
        ...
        <div class="h-full overflow-auto chat-messages">
          <div v-for="(message, i) in messages" :key="i" class="flex flex-col p-4">
            ...
            <div v-else class="pl-8 ml-auto">
              <div class="p-2 mt-1 text-sm text-white bg-eth-blue rounded-lg">
                {{ message.message }}
              </div>
            </div>
          </div>
        ...
        <form @submit.prevent="sendPrompt">
          <div class="flex items-center w-full p-4">
            ...
            <button
              :disabled="loading"
              type="submit"
              class="flex items-center justify-center flex-none w-10 h-10 ml-2 bg-blue-500 rounded-full"
            >
              <svg
                width="24"
                height="24"
    ...
    <div class="flex flex-col justify-center w-full my-4">
      ...
      <div class="flex flex-col items-center justify-center">
        <a
          href="https://github.com/baturalpguvenc/for-atlaspad-nuxt-ai-chatbot"
          class="flex items-center font-medium underline transition-colors underline-offset-4 hover:text-black/70"
        >
...
.bg-eth-blue {
  background-color: #3C3C3D; /* Ethereum Blue */
}
</style>
